        ...
        <div className="flex flex-col justify-center w-full max-w-2xl">
            <div className="px-6 py-6 border border-sky-300 bg-white rounded-md">
                ...
                <div className="mb-2">
                    ...
                    <input readOnly type="number" defaultValue={doctor.yoe} className="border border-sky-300 text-gray-900 text-sm rounded-md block w-full p-2 focus:outline-none"/>
                </div>
            </div>
        </div>
   </div>
